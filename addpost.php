...
<body>
 ...
 <section id="main">
 <!-- <form action="addposttodb.php" method="POST" id="register-form">
      <fieldset>
	    <dl>
		 <dt><label for="ciekawostka">Ciekawostka:</label></dt>
		  <dd><input type="text" name="ciekawostka" id="ciekawostka" placeholder="Ciekawostka"></dd>
		 <dt><input type="submit" name="check" value="Dodaj ciekawostkę"></dt>
		</dl>
	  </fieldset>
    </form>-->
     <?php
